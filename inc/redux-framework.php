    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields' => array(
            ...
            array(
                ...
                'type'             => 'text',
                'title'            => esc_html__('Project featuring fee ', 'prolancer').prolancer_get_currency_symbol(),
                "default"          => 5,
            ),
            array(
                'id'               => 'prolancer_service_featuring_fee',
                'type'             => 'text',
                'title'            => esc_html__('Service featuring fee ', 'prolancer').prolancer_get_currency_symbol(),
                "default"          => 5,
            )
        )
    ));
